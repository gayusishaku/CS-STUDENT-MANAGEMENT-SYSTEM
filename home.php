...
<center>
		...
		<a href="choose-color.php" style="text-decoration:none; color:skyblue; margin-left:10px; padding-top:-40px; font-family:tahoma;">Customize</a></p>
				<a href="echat/sis/profile.php"><h3 style="color:yellow; font-family:Comic Sans Ms">&nbsp;Profile </a></p>
			
				<td align="right">
				
					<a href="logoutchat.php"><div id="lo-but"><p style="font-family:Comic Sans Ms; font-size:18px;">/log-out</p>
					</div></a>
				</td>
			</tr>
		</table>
